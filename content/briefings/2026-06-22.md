...
Open weights are closing on proprietary frontier models fast — now state-of-the-art on specific tasks, near-frontier on coding. Aaron Levie's read: the gap is "marginal, not widening," pushing value up into the applied layer where open weights enable sovereign AI, custom post-training, and cost optimization [Aaron Levie on X (1 min read)](https://x.com/levie/status/2068434042148782515). This week's GLM 5.2 — MIT-licensed, 1M-context, strong coding and agentic gains — is the proof point [Zai on X (1 min read)](https://x.com/Zai_org/status/2066938937344495629). The signal for sellers: the model is becoming the commodity. Durable advantage moves to the substrate — compute economics, data gravity, governance — and to the founder's own data and workflow layer.
...
Noam Shazeer — co-inventor of the Transformer and Mixture-of-Experts — has left Google to become OpenAI's architecture research lead [Sam Altman on X (1 min read)](https://x.com/sama/status/2067427421083652131). It follows other senior DeepMind departures, including AlphaFold lead John Jumper [Samira Manabi on X (1 min read)](https://x.com/samiramanabi/status/2068367450085998998) — a real loss of frontier talent for Google.
