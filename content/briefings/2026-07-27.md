...
-   **[Google cuts Gemini 3.6 Flash to $7.50/M output tokens, and the launch splits by workload (33 min read)](https://podcasters.spotify.com/pod/show/nlw/episodes/Wait----Just-How-Good-IS-GPT-6-e3mdt99)** — the price drop from $9 comes with token-efficiency claims of 17-65% but benchmarks that sometimes trail 3.5 Flash, making adoption a per-workload routing decision rather than a verdict — while the open question hanging over the lineup is where Gemini 3.5 Pro went.
...
-   **[Factory's Matan Grinberg on the coming "dark factory" where software builds itself (52 min watch)](https://www.youtube.com/watch?v=ZesOukBjPmI&t=530s)** — on Sequoia's Training Data, he argues the endgame of coding agents is a software plant with no humans in the loop, and offers a timing warning for founders: "being 2 or 3 years early is the same as being wrong."
...
*Sources: 4 bookmarks, 1 video, 12 podcast episodes from the AI content library. [Archive](/archive)*