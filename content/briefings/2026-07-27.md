...
-   **"Value maxing" replaces "token maxing."** OpenAI's GPT-5.6 explicitly shifts to optimizing AI for outcomes and ROI, with new techniques slashing agentic costs.
-   **Tens of thousands of agents are running.** Companies are already deploying massive agent fleets, pushing IT budgets from traditional software to foundational AI infrastructure.
...
The AI market is rapidly devolving into a geopolitical price war, with Chinese models aggressively undercutting Western frontiers. Moonshot AI's Kimmy K3, which recently shocked the market with its capabilities, is now priced at just **$15 per million output tokens**, a sharp contrast to Anthropic's Fable 5 at **$50** for the same output [Pivot (78 min watch, 0:37:25)](https://www.youtube.com/watch?v=dm7rTPnfK8). Scott Galloway calls this "AI dumping," stating that the race "will be won by whoever can drive margins to zero the fastest," and notes Chinese open-weight models now account for 53% of US AI consumption [Pivot (78 min watch, 0:40:08, 0:44:03)](https://www.youtube.com/watch?v=dm7rTPnfK8).

This economic pressure is fueling a US response: Treasury Secretary Scott Besant is threatening sanctions against Chinese AI companies, alleging "industrial-scale distillation attacks" and the presence of US model watermarks in their models [AI Daily Brief (33 min read, 13:00)](https://podcasters.spotify.com/pod/show/nlw/episodes/Wait----Just-How-Good-IS-GPT-6-e3mdt99). The backdrop is a global scramble for compute: Google is forecasting $195-205 billion in CapEx this year, and Meta is leasing its data center capacity to Anthropic for $10 billion over two years, similar to a deal Anthropic made with SpaceX [All-In (94 min watch, 0:57:15, 0:52:16)](https://www.youtube.com/watch?v=wcV0SRPFK9s). However, new data center construction faces public backlash over environmental concerns, with XAI's Colossus 2 project in Tennessee facing criticism for unpermitted gas turbines in predominantly black neighborhoods [Pivot (78 min watch, 0:55:50)](https://www.youtube.com/watch?v=dm7rTPnfK8). The conflict between cheap AI, national security, and the physical cost of compute is now front and center.
...
2.  **How they're hedging:** "Are you set up to leverage cost-efficient open models without compromising your IP, or navigate potential sanctions without a full vendor lock-in?"
...
OpenAI is explicitly shifting the industry from "token maxing" to "value maxing" with its GPT-5.6 model family. "Value maxing" measures AI progress by "what AI is actually helping you to accomplish" – work done, time saved, quality improved – rather than just how much AI you use [The OpenAI Podcast (55 min watch, 0:06:05)](https://www.youtube.com/watch?v=jyuyY86GJnA). This strategic pivot is driven by the reality that agentic loops, which call multiple tools, generate an N-squared amount of tokens as context accumulates, making raw token spend prohibitive [The OpenAI Podcast (55 min watch, 0:30:11)](https://www.youtube.com/watch?v=jyuyY86GJnA).
...
-   **Drive cost-optimized multi-model infrastructure.** In the face of AI dumping and the "race to zero margins," position the Agent Platform (Model Garden) as the ideal home for running diverse models — Gemini, Anthropic, or open weights like Kimmy K3 — with dynamic routing, allowing founders to leverage cost advantages and optimize token spend.
