...
### Curative Cuts 80% of Its SaaS Spend for Internal AI Agents

Same pattern, different industry: Fred Turner, CEO of health startup Curative, says the company is cutting **80% of its SaaS spend this year** — including canceling a **$600K/year Salesforce contract** — and replacing it with a "vibe-coded" internal CRM wired to AI agents. Agents now run back-office work like doctor credentialing, dropping the cost from ~$50 to about 20 cents per task, and Turner claims "current gen models can do every back-office task we have at Curative." The catch worth flagging: Curative's Anthropic bill has climbed into the millions per month — "build" trades SaaS seats for token spend [Fred Turner on 20VC (90 min watch, 0:47:35, 0:43:00)](https://www.youtube.com/watch?v=GHRuerXkHlI).
