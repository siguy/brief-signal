...
Compute scarcity is now the dominant constraint on frontier AI — and **provisioned throughput is becoming table stakes**, not a "nice to have." At the same time, the agent economy is no longer abstract: Stripe is rebuilding payments around it, and Cursor + Anthropic mega-deals are redefining how the next wave of AI companies gets built.
...
**Conversation starter:** "Where does your gross margin land 12 months from now as inference usage scales? Cursor's $60B exit was essentially a compute deal — they had revenue, but margins were getting eaten by inference costs. That single number — your forward gross margin — is becoming the line between staying independent and being forced into a hyperscaler partnership."
