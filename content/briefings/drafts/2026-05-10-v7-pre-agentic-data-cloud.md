...
- **Multi-year capacity commitment deals** for founders whose 2027 inference plans need *contracted* allocation from *somewhere* — every hyperscaler is squeezed; this is about which provider locks in the commitment, not who has spare GPUs
...
- "Which workload would hurt most to lose — and is your allocation for it *contracted*, or are you competing with everyone else in your vendor's portfolio when supply tightens?"
