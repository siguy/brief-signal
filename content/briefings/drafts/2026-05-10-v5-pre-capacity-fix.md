...
- **AWS-Bedrock-to-GEAP migrations** — same Anthropic models, less single-vendor exposure
- **Provisioned throughput contracts on Gemini** — predictable cost when supply is the pricing lever
- **New compute commitments** from customers feeling the AWS/Azure squeeze
